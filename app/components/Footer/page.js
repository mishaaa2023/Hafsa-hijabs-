...
const Footer = () => {
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <span className="ml-3 text-xl great-vibes-regular text-white">Hafsa Hijabs</span>
    </a>
    ...
    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      <a className="text-white hover:bg-white hover:text-black p-2 rounded">
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
          <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
        </svg>
      </a>
      <a className="ml-3 text-white hover:bg-white hover:text-black p-2 rounded">
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
